...
function AddReception() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await api.post('accounts/receptionists/create/', payload, {
                headers: { Authorization: `Bearer ${token}` }
            });

            setMessage({ type: 'success', text: 'Reception added successfully! Redirecting...' });
            ...
            console.log(error);
            setMessage({ type: 'error', text: error.response?.data?.message || 'Failed to add reception. Please try again.' });
        } finally {
            setIsLoading(false);
        }
    };
    return (
        <>
            <Navbar />
            <div className="add-reception-page">
                <div className="container">
                    <div className="page-header">
                        <div className="header-content">
                            <div className="header-icon">👤</div>
                            <div>
                                <h1 className="page-title">Add New Receptionists</h1>
                                <p className="page-subtitle">Register a new reception in the clinic management system</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <form onSubmit={handleSubmit}>
                                ...
                                <div className="col-lg-6 mb-4">
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            placeholder="Enter reception's full name"
                                            value={formData.name}
                            ...
                            <div className="form-actions">
                                <button
                                    ...
                                    disabled={isLoading}
                                >
                                    {isLoading ? 'Saving...' : '✓ Save Reception'}
                                </button>
                            </div>
                        </form>
                    </div>
